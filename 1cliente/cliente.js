...
app.get('/solicitar_pedido', (req, res) => {
  ...
  axios.post('http://localhost:4000/solicitar_pedido', {test1:numeroAleatorio})
    .then(response => {
...
app.get('/verificar_pedido_restaurante', (req, res) => {
  ...
  axios.post('http://localhost:4000/verificar_pedido_restaurante', {test1:numeroAleatorio})
    .then(response => {
        console.log(response.data)
      res.send(`Restaurante: ${response.data}`);
    })
...
app.get('/verificar_pedido_repartidor', (req, res) => {
  ...
  axios.post('http://localhost:5000/verificar_pedido_repartidor', {test1:numeroAleatorio})
    .then(response => {
        console.log(response.data)
